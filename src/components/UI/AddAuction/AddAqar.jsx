...
const handleAuctionTypeChange = (e) => {
  ...
  const handleSubmit = async (event) => {
    ...
    formAqar.append('start_time',startTime);
    formAqar.append('end_time',endTime);
    ...
    try {
      await axios.post('http://localhost:8000/api/v1/user/real-estate-auctions', formAqar,config)
      setLoading(false);
      setShowAlert(false);
      navigate('/aqar');
    } catch (error) {
