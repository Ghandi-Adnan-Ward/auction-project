  ...
  return (
    ...
    <div className="car__item">
        <div className="car__img">
          <img src={`http://localhost:8000/storage/${image}`} alt="decreasing" className="w-100" />
        </div>
      ...
      ???.???  
          ...
          <div className="car__item-info d-flex align-items-center justify-content-between mt-3 mb-4">
           ...
           {status === 'pending' ? (
               <div>
               <br />
               <p className="section__subtitle text-center">المناقصة تبدأ بعد أقل من دقيقة</p>
               <br />
             </div>
            )
             : status==='ongoing' ? (
            ...
            (
              ...
              <p className="section__title1 text-center">رابح المناقصة: {WinnerData}</p>
            </div>
