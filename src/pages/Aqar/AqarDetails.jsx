...
const AqarDetails = (props) => {
  const {name,minimum_bid ,end_time,details,image,id ,status,description,current_bid,type,increment_amount,model_link} =  props.aqarData ;
