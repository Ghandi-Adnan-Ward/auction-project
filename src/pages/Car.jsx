...
//   const url2='http://localhost:8000/api/v1/user/anonymous-auctions/'+id+'/bid'
...
//     }
//   }
//         axios.post('http://localhost:8000/api/v1/user/live-auctions/66/bid',config)
//        .then(res=>{
...
//       try {
//         axios.post('http://localhost:8000/api/v1/user/regular-auctions/72/bid',bbid,config )
//        .then(res=>{
//          setLoading(false)
//          setShowAlert(false)
//         console.log(res.data)
...
//       try {
//         axios.post('http://localhost:8000/api/v1/user/anonymous-auctions/75/bid',bbid,config )
//        .then(res=>{
//          setLoading(false)
//          setShowAlert(false)
//         console.log(res.data)
