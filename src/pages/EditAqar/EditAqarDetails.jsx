...
const EditAqarDetails = (props) => {
  ...
  const [aqardescription,setaqardescription]=useState(details?.description)
  ...
  return (
      ...
      {/* {loading ? <Spinner /> : */}
       ...
       {showAlert && (
      <Alert severity="success" className="custom-alert mt-4"sx={{display:'flex',alignItems:'center',justifyContent:'center'}}  >
