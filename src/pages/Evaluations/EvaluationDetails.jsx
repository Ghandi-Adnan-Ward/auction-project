...
const EvaluationDetails = (props) => {
  const {name,minimum_bid ,end_time,image,id ,status,description,current_bid,type} =  props.Data ;
      ...
      <section>
        <Container>
          ...
          <div className="form m-4">
            <h1 className="section__title">ادخل السعر المتوقع</h1>
            <TextField 
            ...
            <br />
            <Button type="submit"  className="mt-2 p-2" variant="contained" color="primary">تقييم</Button>
               <br />
                <p>الوقت المتبقي لانتهاء التقييم : {formatTime(remaing)}</p>
                <p>{ }</p>
                <br />
            </div>
        </form>:
