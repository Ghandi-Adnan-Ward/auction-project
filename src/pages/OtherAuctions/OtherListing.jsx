 ...
 let handleSubmit = async (event) => {
   ...
   if (text === "") {
     fetchData();
      ...
      try {
        const res = await axios.get('http://localhost:8000/api/v1/user/search/others?q='+text,config)
        setData(res.data)
       ...
       <Container className="mt-5">
        ...
        <div className="mb-5  ">
            <form onSubmit={handleSubmit} className="d-flex align-items-center justify-content-center">
                <TextField onChange={handleChange} value={text} id="cars" label="Other Search" variant="outlined" className="w-50"    required />
